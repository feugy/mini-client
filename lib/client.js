...
class Client {
  ...
  /**
   * @summary Builds a new remote or local client
   * @description Local clients need full service definition, including `opts.name` and `opts.version`.
  ...
  /**
   * @summary Initialize the client by registering APIs as client's method.
   * @description `init()` needs to be called for local clients, as it will invoke service definition's
 ...
 * @summary Creates a client that exposes all µService's functionnalites.
 *
